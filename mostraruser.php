...
try{
   ...
   foreach ($resultado as $r) {
       echo "Numero Identificar: " .base64_decode($r->getNumeroIdentificacao());
       echo "<br>Nome Completo: ".base64_decode($r->getNomeCompleto()) ;
       echo "<br>Data de Nascimento: ".base64_decode($r->getDataNasc());
       echo "<br>Ano de Frequencia: ".base64_decode($r->getClasseFrequencia());
       echo "<br>Área de Formacao: ".base64_decode($r-> getAreaFormacao());
       echo "<br>Morada: ".base64_decode($r->getEndereco());
       echo "<br>Numero de Telefone: ".base64_decode($r->getNumeroTel());
       echo "<br>Numero de Telefone Alt: ".base64_decode($r->getNumeroTelAlter());
       echo "<br>Id de Acesso: ".base64_decode($r->getIdAcesso());
       echo "<br>Senha: ".base64_decode($r->getSenha());
       echo "<br>Tipo de Utilizador: ".base64_decode($r->getCategoria());
   }
} catch (Exception $exc)   
{
    echo $exc->getMessage(); 
