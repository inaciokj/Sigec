...
<html>
<head>
<title>Eliminar User :: SIGEC</title>
...
<div class="banner banner5">
	<div class="container">
	<h2>Eliminar um Utilizador</h2></div>
</div>
<!--header-->
...
try{
    ...
    $al->deleteByFilter($db, 0);
   
    $p = $db->exec('Alter table aluno id auto_increment = 1');
    
   echo "<br>DADOS ELIMINADOS COM SUCESSO !!!"; 
