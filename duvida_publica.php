...
<html>
<head>
<title>Publica Dúvida :: SIGEC</title>
 ...
 */
    ...
    include_once 'class/UtilizadorModel.class.php';
                                        ...
                                        try {
                                            ...
                                            $duv->setDisciplina($_POST['disciplina']);
                                            $duv->setCurso($_POST['curso']);
    
                                            $duv->insertIntoDatabase($db);   
    
                                            echo "<br><br>DÚVIDA PUBLICADA COM SUCESSO!!!<br><br>";      
                                        } 
                                        catch (Exception $exc) 
                                        {
                                            echo $exc->getMessage();                                
